...
caro_merge <- rbind(caro, caro_3, caro_6, caro_9)
...
Caro_speed <- ggplot(data = caro_merge) +
...
ggsave(plot = Caro_speed, filename = "Caro_Speed.pdf", width = 17, height = 14, units = "cm", dpi = 5000)
